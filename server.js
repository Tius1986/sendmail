...
app.use(cors({
    ...
    // Se il tuo frontend gira su una porta diversa in locale, aggiorna localhost.
    // Per la produzione, imposta la variabile d'ambiente FRONTEND_URL al dominio di SOEK.
}));
...
app.post('/send-email', async (req, res) => {
    ...
    // Validazione base (puoi aggiungere di più)
